...
public class HumanPakourAgent : HumanoidAgent
{
    public Transform Destination;
    public Transform bodyHumanoid;
    ...
    public ContractDetector ChestCD;
    [HideInInspector] public Vector3 InitialPos;

    void Start(){
        // HeadCD = transform.Find("head").GetComponent<ContractDetector>(); // let manually do it! 
        // ChestCD = transform.Find("chest").GetComponent<ContractDetector>();
    ...
    void FixedUpdate(){
        ...
        AddReward(HeadCD.GetCurrent() * -0.05f + ChestCD.GetCurrent() * -0.05f);
        currentSteps += 1;
